...
public class CreateCourseAndReviewsDemo {
	...
	try {
		...
		//add some reviews
		tempCourse.addReviews(new Review("Great course, recommend it for newbies!"));
		tempCourse.addReviews(new Review("Fantastic course, you deserve 5 stars!"));
		tempCourse.addReviews(new Review("What a stupid course!"));
